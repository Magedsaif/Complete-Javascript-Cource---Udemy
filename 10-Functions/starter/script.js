...
for (const movement of movements) {
  if (movement > 0) {
    ...
    console.log(`you withdrew ${Math.abs(movement)}`); // to remove the sign
  }
}

// using the for each method toachieve the same result nut in a much easier way

// for each is a higher order function wich requires a callback function-forech will call the call back function

// ForEach will loop over the array and execute the callback function in each iteration
